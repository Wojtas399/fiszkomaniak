...
void main() {
  ...
  test('compare times, hour of time1 is higher', () {
    ...
    final int result = utils.compareTimes(time1, time2);
  ...
  test('is past time, past date', () {
    ...
    final bool isPastTime = utils.isPastTime(time, date);
  ...
  test('is now, true', () {
    ...
    final bool result = utils.isNow(time, date);
  ...
  test('is time 1 earlier than time 2, true', () {
    ...
    final bool result = utils.isTime1EarlierThanTime2(
      time1: time1,
      time2: time2,
    );
